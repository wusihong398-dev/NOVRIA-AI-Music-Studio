...
Write-Host 'Juweier Music v3.4.0 published-product server starting on port 8001'
Write-Host 'Clients read only validated published products; opening an app never scans a disk.'
Write-Host "Bulk originals: $env:JUWEIER_SERVER_LIBRARY_ROOTS"
Write-Host "Published products: $env:JUWEIER_PROCESSED_DIR\01_Ready"
Write-Host 'Mega53: active chunk on CUDA; overlap-add in system RAM; no CPU fallback'
