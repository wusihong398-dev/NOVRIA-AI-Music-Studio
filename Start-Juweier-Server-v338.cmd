...
echo Starting Juweier Music v3.3.8 low-VRAM server...
start "Juweier Music v3.3.8 Server" powershell.exe -NoExit -ExecutionPolicy Bypass -File "%~dp0Start-Juweier-Server-v338-Low-VRAM-Pilot.ps1"
endlocal
