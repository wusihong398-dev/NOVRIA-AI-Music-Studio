...
echo Run Start-Juweier-Server-v335-Demucs-Mega53-Pilot.ps1 first.
pause
exit /b 2
...
echo.
echo Three pilot records were reset for the verified explicit-path MVSep retry.
echo Keep the v3.3.5 server window open until all three jobs finish.
pause
endlocal
