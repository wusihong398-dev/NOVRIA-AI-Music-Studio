...
Write-Host 'Juweier Music v3.5.0 multi-disk product server starting on port 8001'
Write-Host 'Originals: H:\juweier-music'
Write-Host 'Products: G first, F second; each disk keeps at least 15% and 30 GB free.'
Write-Host 'Published songs stay online when the batch pauses at the reserve line.'
