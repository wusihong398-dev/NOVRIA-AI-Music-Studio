...
Write-Host 'Juweier Music v3.3.9 server pilot starting on port 8001'
Write-Host 'Publishing: all visible Chinese labels, lyrics, scores and product names use Simplified Chinese'
Write-Host 'Mega53: active chunk on CUDA; overlap-add in system RAM; no CPU fallback'
Write-Host 'Safety: one song only; 120-minute hard timeout'
