...
echo Starting Juweier Music v3.4.0 published-product server...
start "Juweier Music v3.4.0 Server" powershell.exe -NoExit -ExecutionPolicy Bypass -File "%~dp0Start-Juweier-Server-v340-Products.ps1"
endlocal
