...
echo Run Start-Juweier-Server-v336-Demucs-Mega53-Pilot.ps1 first.
pause
exit /b 2
...
echo.
echo Three pilot records were reset for the compatible Mega53 runner.
echo Keep the v3.3.6 server window open until all three jobs finish.
pause
endlocal
