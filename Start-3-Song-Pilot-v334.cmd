...
echo Run Start-Juweier-Server-v334-Demucs-Mega53-Pilot.ps1 first.
pause
exit /b 2
...
echo.
echo Three pilot records were reset for the MVSep CLI compatibility retry.
echo Keep the v3.3.4 server window open until all three jobs finish.
pause
endlocal
